module.exports = {
	...
	prefix:  ".papito", // Tip: If you use "<@YOUR_BOT_USER_ID>", you can have the prefix
	                         // be a mention to your bot.

	// Admin app settings
	admin_app: {
		desc: "PapitoBot admin commands",
		prefix: "papitobot-admin"
	},

	// The master channel
	// The bot will announce the events to this channel. It won't listen to other channels.
	master_channel: "425861072717742089",
